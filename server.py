...
class Server:
    ...
    def handle_packets(self):
        ...
        while True:
            ...
            if data==b"TEACHER" and not self.TeacherIn:
                ...
                if len(self.students_frames)>0:
                    ...
                    for i in self.students_frames:
                        ...
                        _,student_port=i
                        name=self.students_frames[i]['Name']
                        packet=(f'Name,{name},{student_port}').encode()
            ...
            elif data.split(b',')[0]==b"STUDENT":
                name=data.split(b',')[1].decode()

                self.students_frames[addr] = {'Name':name,'timeout':time.time(),'frames':{}}
